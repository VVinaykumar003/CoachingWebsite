                ...
                <div key={course._id || course.id} className="flex flex-col bg-white border border-slate-200 rounded-[16px] overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group cursor-pointer">
                  ...
                  <div className="p-4 md:p-5 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-3 mb-3">
                      <div className="flex items-center text-[11px] text-slate-600 font-medium bg-slate-100 px-2 py-1 rounded">
                        <svg className="w-3 h-3 mr-1 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        Self-Paced
                      </div>
                      <div className="flex items-center text-[11px] text-slate-600 font-medium bg-slate-100 px-2 py-1 rounded">
                        <svg className="w-3 h-3 mr-1 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                        Live & Recorded
                      </div>
                    </div>
                    
                    <ul className="mt-1 space-y-1.5 mb-2">
                      <li className="flex items-center text-xs text-slate-600">
                        <span className="text-indigo-500 mr-2 font-bold">✓</span> Comprehensive Study Material
                      </li>
                      <li className="flex items-center text-xs text-slate-600">
                        <span className="text-indigo-500 mr-2 font-bold">✓</span> Regular Mock Tests
                      </li>
                      <li className="flex items-center text-xs text-slate-600">
                        <span className="text-indigo-500 mr-2 font-bold">✓</span> 1-on-1 Doubt Solving
                      </li>
                    </ul>
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100 w-full">
                      ...
                      <a 
                        ...
                        className="block w-full text-center text-sm border border-indigo-400 py-2.5 rounded-md font-bold text-indigo-600 hover:bg-indigo-50 hover:text-indigo-800 transition-colors"
                      >
                        Explore Course
                      </a>
                    </div>
